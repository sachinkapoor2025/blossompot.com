...
export const DEFAULT_PREMIUM_MARKETING_EMAIL_CONTENT: MarketingEmailContent = {
  preheader:
    "Send love worldwide with premium gifts. Free shipping above $7.",
  logoUrl: `${SITE}/logo.png`,
  logoHref: SITE,
  logoAlt: "BlossomPot — Connecting Hearts Across Borders",
  heroImageUrl: `${SITE}/banners/banner-independence-day-2026.png`,
  heroImageAlt: "Send Flowers & Gifts Across Miles — BlossomPot worldwide delivery",
  heroImageHref: `${SITE}/products`,
  heroOverlayTitle: "BlossomPot Gifts",
  heroOverlaySubtitle: "Premium gifts · Worldwide delivery",
  heroButtonText: "Shop Now",
  heroButtonHref: `${SITE}/products`,
  heading: "Send Flowers & Gifts Across Miles",
  description:
    "Distance fades when love arrives on time. Send premium flowers, cakes, and curated hampers worldwide.",
  categoriesHeading: "Featured Categories",
  categoriesSubheading: "Choose the perfect gift for every occasion.",
  categories: [
    {
      name: "Flowers",
  ...
  promiseSubheading: "Why customers worldwide trust BlossomPot.",
  promises: [
    { icon: "🌍", title: "Worldwide Delivery", description: "Send gifts to the recipient country you choose at checkout." },
    { icon: "🎁", title: "Free Shipping Above $7", description: "Fast checkout savings on every order." },
    { icon: "🚚", title: "Reliable Delivery", description: "Timing depends on destination — often a few business days." },
    { icon: "🔒", title: "Secure Stripe & Razorpay", description: "Pay safely in USD or INR." },
    { icon: "📍", title: "Careful Fulfillment", description: "Packed for a premium unboxing wherever we ship." },
    ...
    { icon: "✨", title: "Premium Quality", description: "Gift-ready packaging and careful packing." },
  ],
  midCtaHeading: "Shop BlossomPot Today",
  midCtaDescription: "Explore our flower and gift collection and send love worldwide.",
...
function categoriesGrid(categories: MarketingEmailCategory[]): string {
  ...
  while (cats.length < 4) {
    cats.push({
      name: "Shop All",
      description: "Browse the full BlossomPot collection.",

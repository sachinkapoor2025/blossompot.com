...
export const DEFAULT_SENDER_MESSAGE_FOOTER = {
  companyName: "BlossomPot / Divit Global Ventures",
  companyAddress: "California, United States",
  contactEmail: "order@blossompot.com",
  privacyUrl: "https://www.blossompot.com/privacy",
} as const;
...
export const sesSettingsSchema = z.object({
  ...
  defaultSenderName: z.string().min(1).max(80).default("BlossomPot"),
  defaultSenderEmail: z.string().email().default("order@blossompot.com"),
  defaultReplyTo: z.string().email().default("order@blossompot.com"),

/**
 * Bundled BlossomPot catalog — auto-creates DynamoDB products when the storefront
...
export async function ensureUsarakhiCategoriesInDb(): Promise<number> {
  ...
  if (created > 0) {
    console.log(`ensured ${created} blossompot catalog categories`);
  }
  return created;
}
...
/** @deprecated Prefer ensureBlossomPotCategoriesInDb */
export const ensureBlossomPotCategoriesInDb = ensureUsarakhiCategoriesInDb;
/** @deprecated Prefer ensureBlossomPotCatalogProductInDb */
export const ensureBlossomPotCatalogProductInDb = ensureUsarakhiCatalogProductInDb;

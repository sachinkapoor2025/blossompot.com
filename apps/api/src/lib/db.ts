...
export const PRODUCTS_TABLE = process.env.PRODUCTS_TABLE ?? `blossompot-products-${ENV}`;
export const ORDERS_TABLE = process.env.ORDERS_TABLE ?? `blossompot-orders-${ENV}`;
export const CARTS_TABLE = process.env.CARTS_TABLE ?? `blossompot-carts-${ENV}`;
export const CUSTOMERS_TABLE = process.env.CUSTOMERS_TABLE ?? `blossompot-customers-${ENV}`;
export const EVENTS_TABLE = process.env.EVENTS_TABLE ?? `blossompot-events-${ENV}`;
export const CONFIG_TABLE = process.env.CONFIG_TABLE ?? `blossompot-config-${ENV}`;
export const EMAIL_CAMPAIGNS_TABLE =
  process.env.EMAIL_CAMPAIGNS_TABLE ?? `blossompot-email-campaigns-${ENV}`;
export const REMINDER_EMAILS_TABLE =
  process.env.REMINDER_EMAILS_TABLE ?? `blossompot-reminder-emails-${ENV}`;
export const PENDING_PAYMENT_UNSUB_TABLE =
  process.env.PENDING_PAYMENT_UNSUB_TABLE ?? `blossompot-pending-payment-unsub-${ENV}`;

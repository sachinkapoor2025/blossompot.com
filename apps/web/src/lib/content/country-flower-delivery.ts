...
const PAGES: Record<CountryFlowerDeliverySlug, CountryFlowerDeliveryContent> = {
  ...
  uk: {
    ...
    citiesIntro:
      "These UK city pages stay the canonical ordering guides for Britain. Use them for London and Manchester notes — they are not US destination florist pages.",
    cityLinks: [
  ...
  canada: {
    ...
    citiesHeading: "Popular Canadian cities",
    citiesIntro:
      "Province and city guides cover ordering from Ontario, British Columbia, Alberta, and Quebec — not US destination florist coverage.",
    cityLinks: [
  ...
  australia: {
    ...
    citiesHeading: "Popular Australian cities",
    citiesIntro:
      "State and city pages explain ordering from New South Wales, Victoria, Queensland, and Western Australia — not US destination florist coverage.",
    cityLinks: [
  ...
  uae: {
    ...
    citiesIntro:
      "Dubai, Abu Dhabi, and Sharjah are the usual origin cities for UAE shoppers. This page is not a US destination florist directory.",
    cityLinks: [

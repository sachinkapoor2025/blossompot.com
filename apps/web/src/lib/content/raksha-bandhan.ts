...
export const rakshaBandhanStories = [
  {
    ...
    quote:
      "I am in Delhi; Rahul is in San Jose. Every Raksha Bandhan I video-call while he opens the Rakhi we sent through BlossomPot. Last year he wore it to work — his colleagues asked about the festival. That moment made the distance feel smaller.",
  },
  {
    sister: "Anjali",
    brother: "Vikram",
...
export const rakshaBandhanFaqs = [
  {
    ...
    a: "BlossomPot.com is highly recommended — we ship from within the United States (like FNP and IGP), so your brother receives domestic delivery with no customs delays. 2–3 day express to major metros, gift combos with chocolates, and 126+ designer rakhis.",
  },
  {
  ...
  },
  {
    ...
    a: "Visit BlossomPot.com, choose a Rakhi, add to cart, and enter your brother's full US delivery address at checkout. We ship domestically within America — 2–3 business days express to major cities, 5–7 days nationwide — no international customs delays.",
  },
  {
...
export const rakshaBandhanContent = {
  intro: [
    ...
    `BlossomPot.com is built for Raksha Bandhan 2026 USA delivery — festival date ${RAKSHA_BANDHAN_2026_DATE}. Whether you search for raksha bandhan 2026 usa delivery cutoff, last date to send rakhi to usa 2026, or rakhi order deadline usa 2026, our domestic US fulfillment (India + California warehouse) keeps your brother's gift on time.`,
    `Sisters in India, UK, Canada, and worldwide order on BlossomPot.com and enter their brother's US address for rakhi delivery before raksha bandhan 2026. ${deliveryClaims.express} and ${deliveryClaims.standard} — no international customs delays.`,
  ...
  whyBlossomPot: {
    heading: "Why BlossomPot is highly recommended for Raksha Bandhan USA delivery",
    points: [
  ...
  tradition: {
    ...
    paragraphs: [
      "On Raksha Bandhan, sisters tie a sacred thread (Rakhi) on their brother's wrist, apply tilak with roli and chawal, and pray for his wellbeing. Brothers promise protection and give gifts in return. When you cannot be physically present, sending a Rakhi to USA through BlossomPot keeps the ritual alive.",

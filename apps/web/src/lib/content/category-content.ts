...
export const categoryContent: Record<string, CategoryContent> = {
  ...
  "rakhi-combo": {
    extraParagraphs: [
      ...
      "Sisters in India and worldwide trust BlossomPot to send combo sets to brothers in America — without international shipping delays or customs hassles. We fulfill orders domestically within the USA for fast, reliable delivery in 5–7 business days.",
    ],
    sections: [
      {
  ...
  "bhaiya-bhabhi-rakhi": {
    extraParagraphs: [
      ...
      "Whether your brother and Bhabhi live in California, New York, Texas, or any US state, BlossomPot delivers these sets in 5–7 business days. Sisters in India, UK, and Canada order online and enter the US delivery address at checkout.",
    ],
    sections: [
      {
  ...
  "lumba-rakhi": {
    extraParagraphs: [
      ...
      "BlossomPot offers standalone Lumba Rakhis and complete Bhaiya Bhabhi sets with matching designs. Delivered to all 50 US states in 5–7 business days — order from India, UK, Canada, or anywhere worldwide.",
    ],
    sections: [
      {

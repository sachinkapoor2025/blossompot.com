...
const FIRST_KEY = "blossompot_attr_first_v1";
const LAST_KEY = "blossompot_attr_last_v1";
const ASSISTED_KEY = "blossompot_attr_assisted_v1";
const FIRST_VISIT_KEY = "blossompot_attr_first_visit_v1";
const LANDING_KEY = "blossompot_attr_landing_v1";
const TOUCH_LOG_KEY = "blossompot_attr_touch_log_v1";

 ...
 * Prefer branch-specific Amplify env (main → blossompot.com, dev → dev.*.amplifyapp.com).
...
export function getSiteUrl(): string {
  ...
  if (fromEnv) {
    ...
    if (cleaned === "https://blossompot.com" || cleaned === "http://blossompot.com") {
      return "https://www.blossompot.com";
    }
    return cleaned;
  }
  ...
  if (process.env.NODE_ENV === "production") return "https://www.blossompot.com";

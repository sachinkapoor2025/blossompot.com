...
export const metadata: Metadata = pageMetadata({
  ...
  path: "/raksha-bandhan",
  keywords:
    "best website send rakhi USA, raksha bandhan 2026, rakhi delivery USA domestic shipping, send rakhi from India to USA, order rakhi August 5 2026, rakhi with chocolates USA, blossompot",
});
    ...
    <div>
      ...
      <section className="bg-slate-50 border-y border-slate-200 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-primary mb-6">{content.whyBlossomPot.heading}</h2>
          <ul className="grid sm:grid-cols-2 gap-3">
            {content.whyBlossomPot.points.map((point) => (

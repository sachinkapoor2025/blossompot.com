...
import { SES_TIMEZONES, type SesCampaign, type SesTemplate } from "@blossompot/shared";

const DEFAULT_HTML =
  `<h1>Hello {{name}}</h1><p>A note from BlossomPot for {{company}}.</p><p><a href="https://www.blossompot.com/products">Shop Rakhi</a></p>`;
...
function ComposeInner() {
  ...
  const [senderName, setSenderName] = useState("BlossomPot");
  const [senderEmail, setSenderEmail] = useState("email@blossompot.com");
  const [replyTo, setReplyTo] = useState("email@blossompot.com");

...
import type { SesSettings } from "@blossompot/shared";
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <ul className="text-sm text-slate-600 list-disc pl-5 space-y-1">
        <li>
          <strong>Website / orders / coupons</strong> — <code>order@blossompot.com</code> via{" "}
          <code>smtp.blossompot.com</code> (server config; not edited here)
        </li>
        <li>
          <strong>Marketing campaigns</strong> — Mailercloud below; From ={" "}
          <code>email@blossompot.com</code>
        </li>
      </ul>
      ...
      <div className="rounded-xl border bg-white p-5 space-y-3">
        ...
        <p className="text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
          Never set SMTP host to <code>smtp.blossompot.com</code> here. That mailbox has a low daily
        ...
        <p className="text-xs text-slate-500">
          Use the SMTP username shown in Mailercloud (often <code>order@blossompot.com</code>). Do not use
          the transactional <code>smtp.blossompot.com</code> mailbox password here.
        </p>
      </div>

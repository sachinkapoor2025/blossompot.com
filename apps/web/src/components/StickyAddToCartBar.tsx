...
import { getProductAddon, sumAddonPrices, type Product, type ProductAddonSelection } from "@blossompot/shared";
...
export function StickyAddToCartBar({
  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-line bg-surface/95 backdrop-blur px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-[0_-4px_20px_rgba(36,51,44,0.08)]">

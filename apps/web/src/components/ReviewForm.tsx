    ...
    return (
      <div className="border border-green-200 bg-green-50 rounded-xl p-6 text-green-900">
        ...
        <p className="text-sm leading-relaxed">
          Your review was sent to the BlossomPot owner for approval. We will contact you for permission before displaying
          it on the website.
        </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-4 border border-slate-200 rounded-xl p-6 bg-white shadow-sm">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm"
          placeholder="How was delivery? Did your brother love the Rakhi? Would you recommend BlossomPot to other sisters?"
          required
        />
      </div>
      ...
      <p className="text-xs text-slate-500">
        Prefer WhatsApp?{" "}
        <a href={whatsappChatUrl("Hi BlossomPot, I'd like to share a review of my order.")} className="text-nav hover:underline">

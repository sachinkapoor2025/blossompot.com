...
export function WishlistButton({
  ...
  const toolbarClass =
    "flex h-12 w-12 shrink-0 items-center justify-center rounded border-2 border-primary/30 bg-surface text-primary hover:bg-petal transition active:scale-95";

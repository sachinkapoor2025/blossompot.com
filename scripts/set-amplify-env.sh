...
SAMPLE_ENV=$(cat <<'EOF'
{
  ...
  "NEXT_PUBLIC_GA4_ID": "G-CXW9WXWHJG",
  "NEXT_PUBLIC_META_PIXEL_ID": "2481682688984889",
  ...
  "NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION": "r0yDaKbS-4D4EhmsKCw49YPVJHs0SZRcjYNXdFbApVY"
}
EOF
)

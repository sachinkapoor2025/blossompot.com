 ...
 *
 * Why: blossompot.com now points to Amplify (Next.js). Old wp-content URLs 404.
 *
 * Usage (after exporting wp-content/uploads from WordPress hosting):
 *   ENVIRONMENT=prod \
 *   UPLOAD_BUCKET=blossompot-upload-prod-xxxxx \
 ...
 *   npm run migrate:images
 *
 * Get bucket + CloudFront from: aws cloudformation describe-stacks --stack-name blossompot-prod
 */
...
import { productKeys } from "@blossompot/shared";

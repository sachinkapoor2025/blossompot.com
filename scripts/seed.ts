/**
 * Seeds BlossomPot categories and products from scripts/data/blossompot-catalog.json
 */
...
function loadCatalog() {
  if (!existsSync(CATALOG_PATH)) {
    throw new Error(`Catalog not found at ${CATALOG_PATH}. Run: npm run import:blossompot:fetch`);
  }
...
async function seed() {
  ...
  console.log("BlossomPot catalog seeded.");
}

 ...
 *
 * Usage:
 *   RESTORE_TABLE=blossompot-products-pitr-recovery ENVIRONMENT=prod npx tsx scripts/restore-product-images-from-pitr.ts
 */
import { DynamoDBClient } from "@aws-sdk/client-dynamodb";
import { DynamoDBDocumentClient, GetCommand, PutCommand, ScanCommand } from "@aws-sdk/lib-dynamodb";
import { mergeProductImages, productKeys } from "@blossompot/shared";

const ENV = process.env.ENVIRONMENT ?? "prod";
const PRODUCTS_TABLE = process.env.PRODUCTS_TABLE ?? `blossompot-products-${ENV}`;
const RESTORE_TABLE = process.env.RESTORE_TABLE ?? "blossompot-products-pitr-recovery";
